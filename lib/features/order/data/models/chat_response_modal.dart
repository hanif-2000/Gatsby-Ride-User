...
// To parse this JSON data, do
//
//     final chattingResponseModal = chattingResponseModalFromJson(jsonString);

// import 'dart:convert';

// ChattingResponseModal chattingResponseModalFromJson(String str) => ChattingResponseModal.fromJson(json.decode(str));

// String chattingResponseModalToJson(ChattingResponseModal data) => json.encode(data.toJson());

// class ChattingResponseModal {
//     String response;
//     String message;
//     String type;
//     List<Datum> data;

//     ChattingResponseModal({
//         required this.response,
//         required this.message,
//         required this.type,
//         required this.data,
...
//     factory ChattingResponseModal.fromJson(Map<String, dynamic> json) => ChattingResponseModal(
//         response: json["Response"],
//         message: json["message"],
//         type: json["type"],
