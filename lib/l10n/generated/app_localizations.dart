...
abstract class AppLocalizations {
  ...
  /// No description provided for @yourFeedbackImproveExperience.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @driverReachYourLocation.
  ///
  /// In en, this message translates to:
  /// **'Driver reach your location'**
  String get driverReachYourLocation;

  /// No description provided for @departureToYourDestination.
  ///
  /// In en, this message translates to:
  /// **'Depart to your Destination'**
  String get departureToYourDestination;
  ...
  /// No description provided for @createProfileSuccessfully.
  ///
  /// In en, this message translates to:
  /// **'Create profile Successfully'**
  String get createProfileSuccessfully;
  ...
  /// No description provided for @atLeast8CharactersAndLetters.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @yourRatingHasBeenSubmitted.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Please Give Rating Before Submit'**
  ...
  /// No description provided for @noRatingAvailable.
  ///
  /// In en, this message translates to:
  /// **'No Rating Available'**
  String get noRatingAvailable;
  ...
  /// No description provided for @weAreSearchingNearByDriver.
  ///
  /// In en, this message translates to:
